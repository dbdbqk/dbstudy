...
-- 함수 MY_CEIL 호출
SELECT
       MY_CEIL(1.111, 2)    -- 소수2자리 올림
     , MY_CEIL(1.111, 1)    -- 소수1자리 올림
     , MY_CEIL(1.111, 0)    -- 정수로 올림
...
-- 함수 MY_CEIL 호출
SELECT
       MY_FLOOR(1.111, 2)    -- 소수2자리 내림
     , MY_FLOOR(1.111, 1)    -- 소수1자리 내림
     , MY_FLOOR(1.111, 0)    -- 정수로 내림
