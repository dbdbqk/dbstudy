/*
    ...
    2. 아무 일도 안ㅇ하는 테이블이다.
    3. 오라클은 SELECT - FROM 절이 필수이므로 언제나 테이블이 필요하다.
...
SELECT EMPLOYEE_ID, FIRST_NAME, LAST_NAME
  FROM EMPLOYEES
 WHERE EMPLOYEE_ID = '150'; -- EMPLOYEE_ID = TO_NUMBER('150')을 자동으로 변환한 뒤 처리한다.
...
SELECT 
       TO_CHAR(100)             -- '100'
     , TO_CHAR(100, '999999')   -- '   100' -- 6자리 칼럼 폭으로 맞춰라 공백으로 채워
     , TO_CHAR(100, '000000')   -- '000100' -- 6자리 칼럼 폭으로 맞추고 0으로 채워
     , TO_CHAR(1234, '9,999')   -- '1,234'  -- 천단위 구분기호
