/*
    ...
    3. 문멉은 기본적으로 외부조인/내부 조인과 동일하다.
*/

-- 모든 사람들의 EMPLOYEE_ID, FIRST_NAME, LAST_NAME, MANAGER의 FRIST_NAME을 조회하시오.
...
-- 동일한 부서에서 근무하는 사워들을 조인하기 위해서 DEPARTMENT_ID로 조인
...
-- 1. LOCATION_ID 1700인 부서에 근무하는 사원들의 EMPLOYEE_ID, FIRST_NAME DEPARTMENT_NAME 를 조회하는 문제
-- 1) 표준 문법
...
--2. DEPARTMENT_NAME 이 'EXECUTIVE'인 부서에 근무하는 사람들의 EMPLOYEE_ID, FIRST_NAME을 조회하시오
-- 1) 표준 문법
...
-- 셀렉트문에서 조회하고자 하는 칼럼은 바드시 그룹 바이에 명시되어야 함
